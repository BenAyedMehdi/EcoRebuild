  ...
  return (
    <>
      <div className="flex flex-1 flex-col gap-[27px] h-full items-start justify-start w-full">
        <div className="bg-gray-51 border border-red-101 border-solid flex flex-col items-start justify-start px-5 py-[20px] rounded-[10px] w-full min-h-[400px]"> {/* Adjust min-h-[350px] based on your needs */}
          <Img
