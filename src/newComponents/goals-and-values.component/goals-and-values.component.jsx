            ...
            >
              <div className="text-center flex flex-1 sm:flex-col flex-row gap-[26px] items-start justify-start my-0 w-full">
                <div className="flex flex-1 flex-col gap-[17px] items-start justify-start w-full">
                  ...
                  >
                    {" "}
                    Equipping communities to take ownership of rebuilding their
                    environment.
                  </Text>
                </div>
              </div>
              <div className="flex flex-1 sm:flex-col flex-row gap-[26px] items-start justify-start my-0 w-full">
                <div className="flex flex-1 flex-col gap-[17px] items-start justify-start w-full">
                  ...
                  >
                    {" "}
                    Developing long-lasting, eco-friendly solutions.
                  </Text>
                </div>
              </div>
              <div className="flex flex-1 sm:flex-col flex-row gap-[26px] items-start justify-start my-0 w-full">
                <div className="flex flex-1 flex-col gap-[17px] items-start justify-start w-full">
                  ...
                  <Text
                    ...
                    size="txtManropeRegular18Gray700"
                  >
                    Standing by conflict-affected regions, starting with Gaza,
                    to support renewal and justice.
                  </Text>
                </div>
              </div>
              <div className="flex flex-1 sm:flex-col flex-row gap-[26px] items-start justify-start my-0 w-full">
                <div className="flex flex-1 flex-col gap-[17px] items-start justify-start w-full">
                  ...
                  <Text
                    ...
                    size="txtManropeRegular18Gray700"
                  >
                    Making impactful change possible using the simplest, most
